...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { account: @balance.account, amount: @balance.amount } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { account: @balance.account, amount: @balance.amount } }
