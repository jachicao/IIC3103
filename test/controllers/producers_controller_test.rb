...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { account: @producer.account, group_number: @producer.group_number, producer_id: @producer.producer_id } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { account: @producer.account, group_number: @producer.group_number, producer_id: @producer.producer_id } }
