class PurchaseOrdersController < ApplicationController
  ...
  def index
    ...
    @received_purchase_orders = PurchaseOrder.get_client_orders.select { |v| !(v.dispatched) and !(v.is_rejected or v.is_cancelled) }
    @dispatched_purchase_orders = PurchaseOrder.get_client_orders.select { |v| v.dispatched and !(v.is_rejected or v.is_cancelled) }
