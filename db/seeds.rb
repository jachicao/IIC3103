...
product_in_sale_3	= ProductInSale.create(product: product_2	, producer: producer_2	, average_time: 2.5)
product_in_sale_4	= ProductInSale.create(product: product_2	, producer: producer_4	, average_time: 2.01)
product_in_sale_5	= ProductInSale.create(product: product_2	, producer: producer_6	, average_time: 2.37)
product_in_sale_6	= ProductInSale.create(product: product_3	, producer: producer_3	, average_time: 2.17)
product_in_sale_7	= ProductInSale.create(product: product_3	, producer: producer_5	, average_time: 1.72)
product_in_sale_8	= ProductInSale.create(product: product_4	, producer: producer_4	, average_time: 2.71)
product_in_sale_9	= ProductInSale.create(product: product_4	, producer: producer_6	, average_time: 2.61)
