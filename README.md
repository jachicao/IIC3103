rails generate second_base:migration CreateAzureStoreHouse _id:string:index total_space:integer store_type:string used_space:integer available_space:integer
